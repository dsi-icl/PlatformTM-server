...
namespace eTRIKSService.Controllers
{
    ...
    public class eTRIKSSQLController : ApiController
    {
       // [Route("")]
        ...
        public IQueryable<eTRIKSService.DTO.DomainDataset> getDomainDatasets()
        {
        ...
        [Route("{Domain}")]
        public DTO.DomainDataset getDomainDatasetVariables(string domain)
        {
            ...
            DTO.DomainDataset domainDataset = new DTO.DomainDataset();
            ...
            {
                DTO.DomainVariable dv = new DTO.DomainVariable();
