...
namespace PlatformTM.Data.Migrations
{
    ...
    [Migration("20221114071424_BMO-OP-migration")]
    partial class BMOOPmigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlatformTM.Core.Domain.Model.BMO.Feature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PlatformTM.Core.Domain.Model.BMO.ObservablePhenomenon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ObservedFeatureId")
                        .HasColumnType("int");

                    b.Property<int>("ObservedPropertyId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PlatformTM.Core.Domain.Model.BMO.ObservablePhenomenon", b =>
                {
                    ...
                    b.HasOne("PlatformTM.Core.Domain.Model.BMO.Feature", "ObservedFeature")
                        .WithMany("ObservablePhenomena")
                        .HasForeignKey("ObservedFeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PlatformTM.Core.Domain.Model.BMO.Property", "ObservedProperty")
                        .WithMany()
                        .HasForeignKey("ObservedPropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PlatformTM.Core.Domain.Model.BMO.Property", b =>
                {
                    b.HasOne("PlatformTM.Core.Domain.Model.BMO.Feature", null)
                        .WithMany("FeatureProperties")
            ...
            modelBuilder.Entity("PlatformTM.Core.Domain.Model.BMO.Feature", b =>
                {
                    b.Navigation("FeatureProperties");

                    b.Navigation("ObservablePhenomena");
                });
