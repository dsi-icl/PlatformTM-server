...
namespace PlatformTM.Data.Migrations
{
    ...
    [Migration("20191204171136_ADDSubRecordingSubclass")]
    partial class ADDSubRecordingSubclass
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlatformTM.Core.JoinEntities.VariableQualifier", b =>
                {
                    b.Property<int>("QualifierId");

                    b.Property<int>("VariableId");

                    b.HasKey("QualifierId", "VariableId");

                    b.HasIndex("VariableId");

                    b.ToTable("Variable_Qualifiers");
                });
            ...
            modelBuilder.Entity("PlatformTM.Core.Domain.Model.SubjectRecording", b =>
                {
                    b.HasBaseType("PlatformTM.Core.Domain.Model.Activity");

                    b.Property<string>("SubjectType");

                    b.ToTable("SubjectRecording");

                    b.HasDiscriminator().HasValue("SubjectRecording");
                });
            ...
            modelBuilder.Entity("PlatformTM.Core.JoinEntities.VariableQualifier", b =>
                {
                    b.HasOne("PlatformTM.Core.Domain.Model.DatasetModel.VariableDefinition", "Qualifier")
                        .WithMany("QualifiedVariables")
                        .HasForeignKey("QualifierId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PlatformTM.Core.Domain.Model.DatasetModel.VariableDefinition", "Variable")
                        .WithMany("Qualifiers")
