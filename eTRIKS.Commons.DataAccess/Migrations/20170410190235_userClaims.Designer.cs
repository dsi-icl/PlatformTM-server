...
namespace eTRIKS.Commons.DataAccess.Migrations
{
    ...
    partial class userClaims
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("eTRIKS.Commons.Core.Application.AccountManagement.UserClaim", b =>
                {
                    b.HasOne("eTRIKS.Commons.Core.Application.AccountManagement.UserAccount", "UserAccount")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("eTRIKS.Commons.Core.Domain.Model.HumanSubject", b =>
                {
                    b.HasOne("eTRIKS.Commons.Core.Domain.Model.DatasetModel.DataFile", "SourceDataFile")
                        .WithOne()
                        .HasForeignKey("eTRIKS.Commons.Core.Domain.Model.HumanSubject", "DatafileId")
                        .OnDelete(DeleteBehavior.Cascade);
