        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoadedToDB = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    OID = table.Column<string>(maxLength: 200, nullable: false),
                    DictionaryId = table.Column<string>(maxLength: 200, nullable: true),
                    DataType = table.Column<string>(maxLength: 200, nullable: true),
                    Description = table.Column<string>(maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CharacterisitcId = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    CVtermId = table.Column<string>(nullable: true),
                    CharacteristicObjectId = table.Column<int>(nullable: false),
                    ControlledValueStr = table.Column<string>(nullable: true),
                    DatafileId = table.Column<int>(nullable: true),
                    DatasetDomainCode = table.Column<string>(nullable: true),
                    DatasetId = table.Column<int>(nullable: false),
                    Discriminator = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Characteristics", x => x.CharacterisitcId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Characteristics_CharacteristicObjects_CharacteristicObjectId",
                        column: x => x.CharacteristicObjectId,
