...
namespace eTRIKS.Commons.Persistence.Mapping
{
    public class VariableDefMap : EntityTypeConfiguration<VariableDefinition>
    {
        ...
        //    this.Property(t => t.IsCurated).HasColumnType("bit");
        //    this.Property(t => t.IsComputed).HasColumnType("bit");
        //    this.Property(t => t.ComputedVarExpression).IsOptional();
        ...
        public override void Map(EntityTypeBuilder<VariableDefinition> builder)
        {
